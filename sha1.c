// ---------------------------------------------------------------------------------
// SHA-1 Hashing Library
// ---------------------------------------------------------------------------------
// Routines for hashing data using the SHA-1 hashing algorithm
//
// MODIFICATIONS by David Slik, VE7FIM for use on RP2040 targets:
// - Removed the following hardware-specific routines:
//   - sha1_hardware_hook, 
//   - SHA1UpdateWithHardware,
//   - SHA1UpdateUsePhysicalAddress
// - Removed the following legacy routines:
//   - SHA1Final_r
// - Modified the following routines to remove hardware-specific support:
//   - SHA1Update
// - Re-defined "u_int8_t" as "uint8_t"
// - Re-defined "u_int32_t" as "uint32_t"
// - Removed defines to use bcopy and bzero
//
// ---------------------------------------------------------------------------------
// SPDX-FileCopyrightText: Copyright (c) 2000-2006 Apple Computer, Inc. All rights reserved.
// SPDX-FileAttributionText: https://opensource.apple.com/source/xnu/xnu-1456.1.26/libkern/crypto/sha1.c
